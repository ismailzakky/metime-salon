...
public class ServiceResourceIntTest {
    ...
    public void createService() throws Exception {
        ...
        assertThat(testService.isIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
        assertThat(testService.getMediaFile()).isEqualTo(DEFAULT_MEDIA_FILE);
    ...
    public void updateService() throws Exception {
        ...
        Service testService = serviceList.get(serviceList.size() - 1);
        assertThat(testService.isIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
        assertThat(testService.getMediaFile()).isEqualTo(UPDATED_MEDIA_FILE);
